...
zipFiles.forEach(file => {
  ...
  try {
    ...
    const remoteCommand = `cd ${remoteTempDir} && unzip -o '${path.basename(file)}' && cd ${site.wp_path} && wp media import ${remoteTempDir}/* --porcelain --user=${site.wp_author} && rm -rf ${remoteTempDir}`;
